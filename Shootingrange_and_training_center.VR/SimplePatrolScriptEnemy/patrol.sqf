...
_wp1 = _grpSleeper addWaypoint [_pos, _size,0];
...
_wp2 = _grpSleeper addWaypoint [_pos, _size,1];
...
_wp3 = _grpSleeper addWaypoint [_pos, _size,2];
...
_wp4 = _grpSleeper addWaypoint [_pos, _size,3];
...
_wp5 = _grpSleeper addWaypoint [_wp1pos, 0,4];
